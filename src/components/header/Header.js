...
const Header = () => {
  ...
  return (
    <section>
      ...
      <div className="h-[600px] md:h-[1000px] flex justify-center items-center relative">
        <div
          className={`absolute inset-0 text-white flex flex-col p-5 md:p-40 justify-between my-[80px] bg-gradient-to-tr from-purple-900 to-pink-900 bg-cover bg-center mix-blend-darken `}
          style={{
