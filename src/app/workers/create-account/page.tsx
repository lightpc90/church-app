  ...
  return (
    <div className="flex flex-col items-center justify-between w-full h-screen-dynamic px-5 pb-10 pt-[150px]">
      ...
      <div className="flex flex-col items-center w-full gap-6">
        <div className="relative px-[58px] text-center flex">
          <div className='absolute top-0 left-0'><IoMdArrowRoundBack size={25}/></div>
          <p className="text-[#EE7575] font-bold">Create account</p>
        </div>
        <div className="w-full text-center">
          <h4 className='font-bold text-blue-950'>Glad to have you!</h4>
          <p>Let&apos;s work</p>
        </div>
